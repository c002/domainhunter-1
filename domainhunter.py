...
def resolve_multi_sub_domains(uuid_main, base_fqdn, s_dt):
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'api'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'archief'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'archive'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'cache'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'cdn'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'chat'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'desktop'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'e-mail'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'elastic'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'email'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'gis'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'join'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'map'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'maps'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'media'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'mijn'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'mobiel'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'mobile'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'mon'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'outlook'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'portal'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'secure'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'sso'+'.'+base_fqdn, s_dt)
    ...
    resolve_multi_sub_domains_per_thread(uuid_main, 'wildcard_dns_resolver_goes_to'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'www'+'.'+base_fqdn, s_dt)
    resolve_multi_sub_domains_per_thread(uuid_main, 'www2'+'.'+base_fqdn, s_dt)
